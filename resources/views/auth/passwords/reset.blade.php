                ...
                alert-dismissible fade show" role="alert">
                        ...
                        <form action="{{ route('password.update') }}" method="post" class="mt-4 register-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <label for="email" class="mb-1">Wachtwoord <span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" placeholder="Wachtwoord" name="password" id="password" required aria-label="email">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="email" class="mb-1">Bevestig Wachtwoord <span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" placeholder="Bevestig Wachtwoord" name="password_confirmation" id="password_confirmation" required aria-label="email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mt-3 d-block w-100">Herstellen</button>
                                </div>
                            </div>
