            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-5 col-md-8 col-12">
                    ...
                    <div class="register-wrap p-5 bg-light-subtle shadow rounded-custom">
                        <h1 class="h3">We zijn momenteel in onderhoud.</h1>
                        <p class="text-muted">We zijn momenteel bezig met onderhoud aan onze website om een betere ervaring te bieden. Bedankt voor je geduld. We zullen zo snel mogelijk weer online zijn.</p>
                    </div>
                </div>
            </div>
        </div>
